...
try {
  ...
  //Mail content
  $to = "moagimv@gmail.com"; //info@hklsolarpower.co.za Change this email to your //
  ...
  $mail->Host = 'smtp.gmail.com'; //mail.hklsolarpower.co.za Specify main and backup SMTP servers
  $mail->SMTPAuth = true; // Enable SMTP authentication
  $mail->Username = $to; // SMTP username (The email to be used)
  $mail->Password = '@5830085Tv'; // SMTP password (The password of the email to be used)
